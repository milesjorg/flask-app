...
*/
    ...
    if (this.z < Track.segmentLength * 1.2 && !this.lapStarted) {
      ...
      gameData.lapSplits.push(this.getCurrentLapTime().toFixed(4))
    ...
    if (this.index == 0) {
      ...
      if (this.getSpeed() > gameData.topSpeed) {
        gameData.topSpeed = this.getSpeed()
      }
    }
    ...
    if (this.index === 0 && this.lap === 3 && race.state != STATE_RACEOVER) {
      ...
      gameData.placeFinished = this.finishPosition
